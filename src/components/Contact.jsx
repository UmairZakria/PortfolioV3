...
import { MapPin, MailIcon, MoveRight, Linkedin, Github,Phone  } from "lucide-react"
            ...
            <div className='  '>
                <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1, transition: { duration: 0.6, delay: 0.2 } }} className="  absolute top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 container  min-h-[80vh]   xl:w-3/4 mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 place-content-center backdrop-blur-xs shadow-sm shadow-gray-800 bg-[#00000000]   px-4 py-6 xl:p-8 rounded-2xl">
                    ...
                    <motion.div initial={{ x: 50 }} whileInView={{ x: 0 }} viewport={{once:true}} transition={{ duration: 1, delay: 0.2 }} className=''>
                        ...
                        <motion.h2 initial={{opacity:0,y:50}} viewport={{once:true}} whileInView={{y:0,opacity:1}} transition={{delay:0.,duration:0.5}} className="text-4xl md:text-4xl font-Montserrat font-semibold mt-2">
                    ...
                    {/* Right - Contact Info */}
                    <motion.div initial={{ x: -50 }} whileInView={{ x: 0 }} viewport={{once:true}} transition={{ duration: 1, delay: 0.2 }} className="flex flex-wrap flex-col justify-center">
                        <motion.p initial={{opacity:0,y:60,x:20}} viewport={{once:true}} whileInView={{x:0,y:0,opacity:1}} transition={{ duration: 0.6, delay: 0.2 }}  className="text-gray-100">
                        Every idea holds the power to shape the future. <br />
                        A single step forward can create something extraordinary
                        </motion.p>
                        ...
                        <div className="mt-6 space-y-2">
                            ...
                            target='_blank'
                                ...
                                className="text-lg flex items-center text-green  text-wrap gap-2 hover:underline"
                            >
                                <Phone size={18} /> +923184394363
                            </a>
                        </div>
                        {/* <div className="mt-6 font-Raleway space-y-2">
                            <p className="text-sm text-gray-300">Head Office</p>
                            <p
                                className="text-lg font-sans flex items-center gap-2"
                            >
                                <MapPin className="text-green " size={18} /> Gullberg III ___  ____   ___
                            </p> */}
                            ...
                            {/* <div className="space-y-4 mt-6">
                                ...
                                >
                                    <MapPin className="text-green " size={18} />  Gulshan Usman, Rahim Yar Khan, Punjab, Pakistan
                                </p>
                                <p
                                    className="text-sm flex items-center gap-2 text-gray-400"
                                >
                                    <MapPin className="text-green " size={18} /> Surti Society, Model Colony, Malir, Karachi, Sindh, Pakistan
                                </p>
                            </div> */}

                        {/* </div> */}
                    </motion.div>
                    {/* <div className="flex items-center border md:col-span-2 justify-between"> */}
                    <div>
                        ...
                        >
                            SEND <MoveRight className="group-hover:translate-x-2 transition-all duration-500 ease-in-out" />
                        </button>
                    </div>

                    <div className="text-green flex items-center justify-evenly  md:1/2 ">
                        <a target='_blank' href="https://www.linkedin.com/in/umair-zakria-67477b33a/" className="group hover:border border-white hover:scale-105  transition-all duration-300 ease-in-out  p-3  rounded-full"> <Linkedin className=" border-white " /></a>
                        <a target='_blank' href="https://github.com/UmairZakria/" className="group  hover:border border-white hover:scale-105  transition-all duration-300 ease-in-out  p-3  rounded-full"><Github /></a>
                        <a target='_blank' href="https://wa.me/923184394363" className="group  hover:border border-white hover:scale-105  transition-all duration-300 ease-in-out  p-3  rounded-full"><svg className=" fill-[white]" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 50 50"
